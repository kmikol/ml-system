...
Queries predictions with annotation_status='none' that have a matching entry in
dataset_samples (joined on prediction_id = sample_id). Up to SAMPLING_CANDIDATES_PER_RUN
rows are atomically selected and advanced to annotation_status='candidate' so the
annotation job can look up their ground truth labels.
